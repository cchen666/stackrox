...
type ClusterMetrics struct {
	CoreCapacity         int64    `protobuf:"varint,1,opt,name=coreCapacity,proto3" json:"coreCapacity,omitempty"`
...
func (m *ClusterMetrics) GetCoreCapacity() int64 {
	if m != nil {
		return m.CoreCapacity
	}
	return 0
}
...
var fileDescriptor_cf4a2b5a7271bdbd = []byte{
	...
	0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x62, 0x87, 0x4a, 0x2b, 0x99, 0x70, 0xf1, 0x39, 0x43, 0x54,
	0xf8, 0x42, 0x14, 0x08, 0x29, 0x71, 0xf1, 0x24, 0xe7, 0x17, 0xa5, 0x3a, 0x27, 0x16, 0x24, 0x26,
	0x67, 0x96, 0x54, 0x4a, 0x30, 0x2a, 0x30, 0x6a, 0x30, 0x07, 0xa1, 0x88, 0x39, 0x49, 0x9e, 0x78,
	0x24, 0xc7, 0x78, 0xe1, 0x91, 0x1c, 0xe3, 0x83, 0x47, 0x72, 0x8c, 0x33, 0x1e, 0xcb, 0x31, 0x44,
	0xc1, 0x0c, 0x4c, 0x62, 0x03, 0x5b, 0x60, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0x79, 0x67, 0xa4,
	0x73, 0x8d, 0x00, 0x00, 0x00,
}
...
func (m *ClusterMetrics) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.CoreCapacity != 0 {
		i = encodeVarintClusterMetrics(dAtA, i, uint64(m.CoreCapacity))
		i--
		dAtA[i] = 0x8
	}
...
func (m *ClusterMetrics) Size() (n int) {
	...
	_ = l
	if m.CoreCapacity != 0 {
		n += 1 + sovClusterMetrics(uint64(m.CoreCapacity))
	}
	if m.XXX_unrecognized != nil {
...
func (m *ClusterMetrics) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field CoreCapacity", wireType)
			}
			m.CoreCapacity = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.CoreCapacity |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
